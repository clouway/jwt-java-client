...
public class PemTest {
  ...
  public void decodeWhatWasEncodedInPemFormat() throws Exception {
    ...
    Pem.Block block = pem.parse(new ByteArrayInputStream(encoded.getBytes()));

    assertThat(block, is(equalTo(new Pem.Block("RSA PRIVATE KEY", ImmutableMap.<String, String>of(), keyAsBytes))));
  }
